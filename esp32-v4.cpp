...
void readBattery(){
  int adcVal = analogRead(BATT_PIN);
  batteryVoltage = adcVal * (3.3 / 4095.0);
  batteryVoltage = batteryVoltage * ((10000.0 + 4700.0) / 4700.0);
  batteryPercent = (batteryVoltage - 6.0) / (9.0 - 6.0) * 100.0;
